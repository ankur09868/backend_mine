...
class Account(models.Model):
    ...
    assigned_to = models.ManyToManyField(User, related_name='account_assigned_to',blank=True, null=True)
    createdBy = models.ForeignKey(User, related_name='account_created_by', on_delete=models.CASCADE,blank=True, null=True)
